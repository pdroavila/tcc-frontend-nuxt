          ...
          <table class="min-w-full bg-white">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nome Completo</th>
            ...
            <tbody class="divide-y divide-gray-200">
              <tr v-for="admin in admins" :key="admin.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center">{{ admin.nome_completo }}</td>
