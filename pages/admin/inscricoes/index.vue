    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <div class="flex flex-wrap justify-center md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="flex flex-col">
          ...
          <select v-model="filters.curso" class="border rounded-md p-2">
        ...
        <div class="flex flex-col">
          ...
          <select v-model="filters.status" class="border rounded-md p-2">
            ...
            <tr v-for="inscricao in inscricoes.results" :key="inscricao.id">
              ...
              <td class="px-6 py-4 text-center">
                <button
                  ...
                  class="px-3 py-1 text-sm bg-green-100 text-white rounded-md hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                  Ver Detalhes
                </button>
              </td>
      ...
      <div class="mt-4 flex justify-between items-center">
        <div class="text-sm text-gray-500">
          Mostrando {{ inscricoes.results?.length || 0 }} de
          {{ inscricoes.count || 0 }} resultados
        </div>
